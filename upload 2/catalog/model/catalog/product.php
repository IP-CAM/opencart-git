...
class ModelCatalogProduct extends Model {
	...
	public function getAttributeGroup(){
		...
		/*
		for($i=0;$i<$attribute_groups->num_rows;$i++){
			$attribute_group_data[]=array('a');
		}*/

		/*
		$attribute_group_data[]=array(
			'name'=>$attribute_groups->rows[1]['name'],
			'attribute_id'=>$attribute_groups->rows[1]['attribute_group_id']
		);*/
		...
		/*	$attribute_group_data[]=array('33333','444444');*/
